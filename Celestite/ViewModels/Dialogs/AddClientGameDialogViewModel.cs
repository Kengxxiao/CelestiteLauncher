...
{
    public partial class AddClientGameDialogViewModel : ViewModelBase
    {
        ...
        public static AutoCompleteFilterPredicate<object> AutoCompleteFilter =>
            (search, item) =>
            {
                ...
                return x.Title.Contains(search, StringComparison.OrdinalIgnoreCase) || x.ProductId.StartsWith(search, StringComparison.OrdinalIgnoreCase);
            };
    }
}

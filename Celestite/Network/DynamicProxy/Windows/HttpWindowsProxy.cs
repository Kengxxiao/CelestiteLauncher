...
using SafeWinHttpHandle = Celestite.Network.DynamicProxy.Windows.Interop.WinHttp.SafeWinHttpHandle;
    ...
    internal sealed class HttpWindowsProxy : IMultiWebProxy, IDisposable
    {
        ...
        public MultiProxy GetMultiProxy(Uri uri)
        {
            ...
            if (_proxyHelper.ManualSettingsUsed)
            {
                ...
                return IsSecureUri(uri) && !_secureProxy.IsEmpty() ? _secureProxy : _insecureProxy;
            }

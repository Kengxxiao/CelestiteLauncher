...
namespace Celestite.Network.DynamicProxy.Windows
{
    ...
    internal sealed partial class RegistryMonitor : IDisposable
    {
        ...
        private static partial int RegOpenKeyExW(IntPtr hKey, string subKey, uint options, int samDesired,
                                               out IntPtr phkResult);

        [LibraryImport("advapi32.dll", SetLastError = true)]
        private static partial int RegNotifyChangeKeyValue(IntPtr hKey, [MarshalAs(UnmanagedType.Bool)] bool bWatchSubtree,
        ...
        private string _registrySubName = string.Empty;
        ...
        {
            int result = RegOpenKeyExW(_registryHive, _registrySubName, 0, STANDARD_RIGHTS_READ | KEY_QUERY_VALUE | KEY_NOTIFY,

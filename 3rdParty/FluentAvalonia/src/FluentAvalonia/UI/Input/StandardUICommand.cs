    ...
    private void SetupCommand()
    {
        switch (Kind)
        {
            ...
            case StandardUICommandKind.Paste:
                Label = "Paste";
                IconSource = new SymbolIconSource { Symbol = Symbol.ClipboardPaste };
            ...
            case StandardUICommandKind.SelectAll:
                Label = "Select All";
                IconSource = new SymbolIconSource { Symbol = Symbol.SelectAllOn };
            ...
            case StandardUICommandKind.Forward:
                Label = "Forward";
                IconSource = new SymbolIconSource { Symbol = Symbol.ArrowForward };
            ...
            case StandardUICommandKind.Backward:
                Label = "Backward";
                IconSource = new SymbolIconSource { Symbol = Symbol.ArrowStepBack };
                Description = "Back";
                // No HotKey
                break;
            ...
            case StandardUICommandKind.Undo:
                Label = "Undo";
                IconSource = new SymbolIconSource { Symbol = Symbol.ArrowUndo };
            ...
            case StandardUICommandKind.Redo:
                Label = "Redo";
                IconSource = new SymbolIconSource { Symbol = Symbol.ArrowRedo };

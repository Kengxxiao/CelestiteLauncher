...
public partial class Frame : ContentControl
{
    ...
    protected override void OnPropertyChanged(AvaloniaPropertyChangedEventArgs change)
    {
        ...
        if (change.Property == ContentProperty)
        {
            ...
            else if (CurrentEntry == null && change.NewValue is Control ctrl)
            {
                CurrentEntry = new PageStackEntry(change.NewValue.GetType(), null, null)
                {
                    Instance = ctrl,
                    Context = null
                };
    ...
    public bool NavigateFromObject(uint target, FrameNavigationOptions navOptions = null)
    {

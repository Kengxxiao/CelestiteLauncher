...
/// </summary>
public class PageStackEntryWithoutReflection : IPageStackEntry
{
    /// <summary>
    ...
    public PageStackEntryWithoutReflection(Type sourcePageType, object parameter, NavigationTransitionInfo navigationTransitionInfo)
    {

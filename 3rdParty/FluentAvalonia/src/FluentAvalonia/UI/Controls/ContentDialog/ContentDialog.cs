...
public partial class ContentDialog : ContentControl, ICustomKeyboardNavigation
{
    ...
    public static event EventHandler<EventArgs>? ContentDialogWantToShow;
    ...
    public Task<ContentDialogResult> ShowAsync()
    {
        ...
        window.Activate();
        return ShowAsyncCoreForTopLevel(window);
    }
    ...
    {
        if (_tcs != null && !_tcs.Task.IsCompletedSuccessfully)
        ...
        ContentDialogWantToShow?.Invoke(this, EventArgs.Empty);
    ...
    public void EmuCloseButtonClicked() => OnButtonClick(_closeButton, null);
